        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gray-800 p-6 rounded-lg text-center hover:bg-gray-700 transition-colors">
              ...
              <a href="https://github.com/lagna360/yt2blog/releases/download/v1.0.1/yt2blog-mac.dmg" className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-6 rounded-lg transition-colors">
                Download for Mac
              </a>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg text-center hover:bg-gray-700 transition-colors">
              ...
              <a href="https://github.com/lagna360/yt2blog/releases/download/v1.0.1/yt2blog-win.exe" className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-6 rounded-lg transition-colors">
            ...
            <div className="bg-gray-800 p-6 rounded-lg text-center hover:bg-gray-700 transition-colors">
              ...
              <a href="https://github.com/lagna360/yt2blog/releases/download/v1.0.1/yt2blog-linux.AppImage" className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 px-6 rounded-lg transition-colors">
                Download for Linux
              </a>
            </div>
          </div>
